...
const outer =
  'mx-auto max-w-[1440px] px-[15px] pb-[100px] [&_p]:text-xl [&_p]:text-[#4c5151] [&_a]:text-[#fb8b25] [&_a]:underline [&_h3]:my-4 [&_h3]:text-2xl [&_h3]:font-semibold [&_h3]:text-[#4c5151] [&_strong]:font-bold [&_ul]:list-disc [&_ul]:py-3 [&_ul]:pl-8 [&_li]:list-disc [&_li]:text-xl [&_li]:text-[#4c5151]';
    ...
    <section className="bg-white pb-[100px]">
      <div className={outer}>
        <div className="mb-[50px] mt-[60px]">
          <h1 className="text-[60px] font-semibold leading-[6.237rem] tracking-[-0.1rem] text-[#4c5151] [&_span]:text-[#fb8b25]">
            <span>Privacy</span> Policy
          </h1>
        </div>
        <div>
          <p>Effective date: December 21, 2018</p>
          <p>
            DM Learning (“us”, “we”, or “our”) operates the <Link href="/">learning.digimantra.com</Link> website (the
            “Service”).
          </p>
          <p>
            This page informs you of our policies regarding the collection, use, and disclosure of personal data when
            you use our Service and the choices you have associated with that data. Our Privacy Policy for DM Learning
            is managed through{' '}
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Information Collection And Use</h2>
        <div>
          <p>
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Use of Data</h2>
        <div>
          <p>DM Learning uses the collected data for various purposes:</p>
          <ul>
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Transfer Of Data</h2>
        <div>
          <p>
          ...
          <p>
            DM Learning will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Disclosure Of Data</h2>
        <div>
          <h3>Legal Requirements</h3>
          <p>DM Learning may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
          <ul>
            <li>To comply with a legal obligation.</li>
            <li>To protect and defend the rights or property of DM Learning.</li>
            <li>To prevent or investigate possible wrongdoing in connection with the Service.</li>
            <li>To protect the personal safety of users of the Service or the public.</li>
            <li>To protect against legal liability.</li>
          </ul>
        </div>
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Security Of Data</h2>
        <div>
          <p>
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Service Providers</h2>
        <div>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              <a href="https://policies.google.com/privacy?hl=en">policies.google.com/privacy?hl=en</a>
            </li>
          </ul>
        </div>
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Links To Other Sites</h2>
        <div>
          <p>
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Children&apos;s Privacy</h2>
        <div>
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Changes To This Privacy Policy</h2>
        <div>
          <p>
        ...
        <h2 className="mb-[50px] mt-20 text-[48px] font-normal text-[#4c5151]">Contact Us</h2>
        <div>
          <p>If you have any questions about this Privacy Policy, please contact us:</p>
          <ul>
            <li>
              By email: <a href="mailto:hello@learning.digimantra.com">hello@learning.digimantra.com</a>
            </li>
            <li>
