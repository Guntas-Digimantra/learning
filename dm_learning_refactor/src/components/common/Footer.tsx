          ...
          <div className="flex flex-1 flex-col gap-14 max-lg:basis-full max-lg:gap-8">
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="flex items-center text-white no-underline opacity-100 transition-opacity duration-200 hover:opacity-70"
          ...
          <div className="flex max-w-[320px] shrink-0 flex-col gap-4 max-sm:max-w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="text-sm font-medium tracking-[0.28px] text-white no-underline transition-opacity duration-200 hover:opacity-70"
              >
                +91-172-613-1700
              </Link>
            </div>
