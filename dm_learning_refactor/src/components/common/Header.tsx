...
function Header() {
  ...
  return (
    <header>
        ...
        <div className="dml-container">
          ...
          <div className="header-right">
            ...
            <ul className="social-icon-list">
              ...
              <li>
                <Link href="https://www.facebook.com/1dmlearning">
                  <FacebookIcon />
                </Link>
              </li>
              <li>
                <Link href="https://www.linkedin.com/company/digimantra-learning/">
                  <LinkedinIcon />
                </Link>
              </li>
              <li>
                <Link href="https://www.instagram.com/_dmlearning/">
                  <InstagramIcon />
                </Link>
              </li>
            </ul>
      ...
      <div className={`sticky-header ${isSticky ? "fixed-header" : ""}`.trim()}>
        <div className="dml-container">
          <nav>
              ...
              <ul className="menu">
                ...
                <li className="dropdown">
                  ...
                  <ul className="dropdown-content">
                    ...
                    <li>
                      <Link href="/microsoft-certifications" className="sublink">
                    ...
                    <li>
                      <Link href="/summer-bootcamp-and-internship" className="sublink">
                        Summer Bootcamp
                      </Link>
                    </li>
                    <li>
            ...
            <div className="contactus">
              ...
              >
                <Image src="/menu-icon.svg" width={30} height={30} alt="" />
              </button>
            </div>
          </nav>
