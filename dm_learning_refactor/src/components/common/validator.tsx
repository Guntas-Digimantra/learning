...
export const validateEmptyFields = (body: any) => {
  const { fullName, program, course, paymentAmount, howDidYouHear, institutionName } = body;
...
export const validateProgramAndCourse = (
  ...
  const validPrograms = ['Summer Bootcamp', 'Advanced Industrial Training & Internship'];
