...
const ContactInfo = () => {
    return (
        <div className="w-[30%] max-[1400px]:min-[1025px]:w-[38%] max-[1024px]:mx-auto max-[1024px]:w-full max-[1024px]:max-w-[700px]">
            <ul className="list-none p-0">
                <li className="mb-[30px] flex items-center gap-[25px] rounded-[10px] border border-[#e1e1e1] bg-[#f7f7fa] p-10">
                    <div className="flex h-[70px] w-[70px] shrink-0 items-center justify-center rounded-full bg-[#fc8b20] text-xl leading-none">
