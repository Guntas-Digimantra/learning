...
export const formRow = 'flex gap-5 max-[767px]:flex-col max-[767px]:gap-[15px]';

export const formField =
  'h-[52px] w-full rounded-[10px] border-0 bg-white px-3 py-3.5 text-base font-normal leading-[21.6px] text-[#565656] outline-none';
