  ...
  return (
    <section className="dml-advantages-section bg-[#f7f7f9]" style={{ padding: '100px 0' }}>
      <div className="dml-container">
        <div className="top-features mb-[50px] text-center">
          <span className="sub-title mb-[14px] inline-block rounded-[30px] bg-[#efeefe] px-4 py-[3px] font-medium leading-[1.62] text-[#5751e1]">
            Our Top Features
          </span>
          <h2 className="title text-[40px] text-[#121212] max-[767px]:pb-[15px] max-[767px]:text-[28px]">
            Experience the DMLearning Advantage
          </h2>
          <p className="mt-[15px] text-base leading-[1.7] text-[#6d6c80]">
              ...
              <div key={item.id} className="flex-[1_1_calc(33.33%-20px)]">
                ...
                >
                  <div className="features__content-two">
                    <div className="content-top flex items-center gap-[15px] pb-6">
                      <div
                    ...
                    <p className="text-base leading-[1.7] text-[#6d6c80]">{item.desc}</p>
                  </div>
                </div>
              </div>
            ))}
