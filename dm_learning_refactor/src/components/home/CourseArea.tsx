...
const CourseArea = () => {
  return (
    ...
    >
      <div className="dml-container courses-container relative" style={{ paddingTop: '50px' }}>
        <Swiper
          {...setting}
        ...
        >
          {course_data[0]?.course_details?.map((item, i) => (
            <SwiperSlide key={i} style={{ height: "auto" }}>
              <div
                className="course-item courses-page-cards relative flex h-full w-full flex-col overflow-hidden rounded-[20px] border-0 bg-white transition-[transform,box-shadow] duration-300 ease-in-out hover:!-translate-y-2"
                style={{
                  padding: "8px",
              ...
              >
                <div
                  className="relative flex !h-[224px] !gap-5 overflow-hidden rounded-t-[16px] border border-[#FFEEE6]"
                  style={{
                ...
                >
                  <div className="course-item-left z-[2] flex !h-full flex-1 flex-col justify-between !p-6 text-white">
                    ...
                    <h3 className="!m-0 !text-[20px] !font-bold !leading-[110%] !text-white">{item.title}</h3>
                    {item.review && (
                        ...
                        <span className="!text-xs tracking-[2px]">
                          {Array.from({ length: 5 }).map((_, starIdx) => (
                            <span
                              ...
                              style={{
                                color:
                                  starIdx < generateStars(item.review).stars ? "#ffffff" : "#ccc",
                              }}
                            >
                              ★
                            </span>
                ...
                >
                  <div>
                    <h5 className="!m-0 !mb-[15px] !text-[18px] !font-bold !leading-[1.3] !text-[#161439]">
                  ...
                  <div className="courses__item-bottom !m-0 flex items-center justify-between !gap-5 max-[767px]:!flex-col max-[767px]:!items-stretch">
                    <Link href={item.url} onClick={(e) => e.stopPropagation()}>
                      <span className="start-learning-link flex items-center gap-2 !text-base !font-semibold !leading-[normal] text-[#fc8b20] no-underline transition-[gap] duration-300 ease-out hover:gap-3 max-[767px]:w-full">
                        Start Learning <span>›</span>
                      </span>
                    </Link>
                    <Link
                      className="dml-button-slider inline-flex !h-10 !w-[120px] items-center justify-center gap-1.5 !rounded-[56px] !border-0 !bg-[#2a2a2a] !px-[19px] !py-2.5 text-sm font-semibold !leading-[18px] !text-white no-underline transition-[background,transform] duration-200 hover:!scale-[1.02] hover:!bg-[#1a1a1a] hover:!text-white max-[767px]:!w-full"
