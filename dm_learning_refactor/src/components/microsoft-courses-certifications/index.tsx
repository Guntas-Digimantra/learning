...
const MicrosoftCoursesCertifications: React.FC<MicrosoftCoursesCertificationsProps> = ({ data }) => {
  return (
    <>
      <Banner title={data.title} image={data.image} description={data.description} />
      <DescriptionOfRole
