    ...
    <section className="terms-condition-section">
      <div className="outer-section">
        ...
        <div className="site_desc">
          ...
          <p>
            DMLearning (“us”, “we”, or “our”) operates the{" "}
            <Link href="/">learning.digimantra.com</Link> website (the
            “Service”).
          </p>
          <p>
        ...
        <div className="site_desc">
          ...
          <p>
            DMLearning will take all steps reasonably necessary to ensure that
        ...
        <div className="site_desc">
          ...
          <p>
            DMLearning may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation.</li>
            <li>
              To protect and defend the rights or property of DMLearning.
            </li>
            <li>
