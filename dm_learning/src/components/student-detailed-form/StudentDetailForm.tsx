    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_APP_URL}/api/send-email`,
        {
          ...
          body: JSON.stringify({
            to: to, // The recipient of the contact form (your email)
            subject: `Student Details Form`, // Dynamic subject line
            message: `
      ...
      >
        ...
        <div className="name-container">
          <div className="w-100">
            ...
            {errors.stateName && (
              <div className="error">{errors.stateName.message}</div>
            )}
          </div>
          <div className="w-100">
            <input
            ...
            />
            {errors.cityName && (
              <div className="error">{errors.cityName.message}</div>
            )}
          </div>
        </div>
          ...
          <div className="w-100">
            ...
            >
              ...
              <option value={ProgramNames.SummerBootcamp}>
                Summer Bootcamp (6 weeks)
              </option>
              <option value={ProgramNames.AdvancedIndustrialTraining}>
                Advanced Industrial Training & Internship (6 Months)
              </option>
              <option value={ProgramNames.BeginnerAICourse}>
                Beginner AI Course (3 weeks)
              </option>
              <option value={ProgramNames.AdvancedAICourse}>
                Advanced AI Course (6 weeks)
              </option>
            </select>
            {errors.program && (
        ...
        <div className="name-container">
          <div className="w-100">
            ...
            {errors.pursuingCourse && (
              <div className="error">{errors.pursuingCourse.message}</div>
            )}
          </div>
          <div className="w-100">
            <select
            ...
            {errors.semester && (
              <div className="error">{errors.semester.message}</div>
            )}
          </div>
        </div>
        ...
        <div className="">
          ...
          />
          {errors.requirements && (
            <div className="error">{errors.requirements.message}</div>
          )}
        </div>
