        ...
        <div className="stats-content">
          ...
          <div className="stats-left">
            ...
            <p className="stats-left-para">
              Embark on a journey through some of our achievements— DML intern&apos;s
              takes pride in numerous successes, showcasing diverse projects and
              milestones that highlight our commitment to excellence and
              innovation.
            </p>
            <Link href="/student-enrollment">
              <button className="dml-button">Join Now</button>
            </Link>
          </div>
