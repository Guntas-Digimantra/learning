      ...
      <div className="dml-container">
        <div className="sign-in-bootcamp">
          <div className="sign-in-left">
            ...
            <p>
              Visit our official website and complete the online application
              form. Be sure to include your resume and a brief statement of
              purpose outlining your interest in the bootcamp.
            </p>
            <div className="btn-wrapper">
              <Link href="/student-enrollment">
                <button className="dml-button">Sign Up</button>
              </Link>
            </div>
          </div>
        ...
        <div className="online-internship-bootcamp">
          <div className="online-internship-left">
            ...
            <p>
              Once your application has been reviewed, you&apos;ll be invited to a
              brief counselling session (online or offline, based on your
              availability). This is also an excellent opportunity to discover
              what DigiMantra offers and how we can assist you in your career.
            </p>
          </div>
        ...
        <div className="skill-up-bootcamp">
          <div className="skill-up-left">
            ...
            <p>
              Once the interview is complete, you will receive an acceptance
              notification via email. If accepted, you&apos;ll get further
        ...
        <div className="online-internship-bootcamp">
          <div className="online-internship-left">
            ...
            <p>
              Follow the instructions in your acceptance email to finalize your
              enrollment, including signing any necessary agreements and paying
              required fees. Get ready to join us at DigiMantra Ludhiana!
            </p>
          </div>
          <div className="online-internship-img">
