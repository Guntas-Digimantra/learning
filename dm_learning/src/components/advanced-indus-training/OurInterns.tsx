        ...
        <div className="our-intern-content">
          <div className="intern-slider">
            ...
            >
              {images.map((item, i) => (
                <SwiperSlide key={i}>
                  <div className="intern-slide-image-wrap">
                    <Image
                      src={item.thumb}
                      alt={"intern-images"}
          ...
          <div className="intern-right-content">
            ...
            <p>
              Interns at DigiMantra work across various teams including software
              engineering, marketing, user experience and more. Our internships
              are available globally and offer many opportunities to learn and
              grow. You can help us build products and services that are used by
              billions of people around the world. Join us today and be a part
              of the revolution.
            </p>
          </div>
        </div>
