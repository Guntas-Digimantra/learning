...
export const metadataMapping: Record<Slug, PageData> = {
  "ai-engineer": {
    ...
    description:
      "Microsoft Learn helps you discover the tools and skills you need to become an AI Engineer.",
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            image: "/mobile-2.png",
            title:
              "Choose the best UI framework for a native Windows development project",
            width: 200,
            height: 140,
  ...
  "data-engineer": {
    ...
    description:
      "Microsoft Learn helps you discover the tools and skills you need to become a data engineer.",
